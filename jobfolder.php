...
<section class="home-section">
    ...
    <form id="job_folder">
        ...
        <div class="form-class align-items-center d-flex">
            <div class="col-auto">
                <select class="form-control" name="role-type" id="jobfolder1" name="role">
                    <!-- <option value="0">Choose Agreements</option> -->
                    
                </select>
            </div>
            <div class="col-auto">
                <select class="form-control" name="role-type" id="jobfolder" name="role">
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#assignFolder">
  Assign Folder
                ...
                <button type="submit" class="btn btn-primary mb-2" style="margin-top:8px;">Save</button>
            </div>
        </div>
    </form>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form id=" formdata1">
                    <div class="form-class align-items-center d-flex">
                        <div class="col-auto">
                            <select class="form-control" name="" id="jobfolder1">
                                <option value="0">Choose Agreements</option>
                        ...
                        <div class="col-auto">
                            <select class="form-control"  id="jobfolder" placeholder="jobfolder">
                               <option value="0">Choose Job Folder</option> 
                                <option value="one" class="form-check-input" type="checkbox">Folder One</option>
                                <option value="Two">Folder Two</option>
                                <option value="Three">Folder Three</option>
